= RSR Compliance: heterogenous-mobile-computing
:toc:
:sectnums:

== Overview

This document describes the Rhodium Standard Repository (RSR) compliance status for *heterogenous-mobile-computing*.
