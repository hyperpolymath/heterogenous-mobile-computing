...
doctor:
    @echo "Running diagnostics for heterogenous-mobile-computing..."
...
heal:
    @echo "Attempting auto-repair for heterogenous-mobile-computing..."
...
tour:
    @echo "=== heterogenous-mobile-computing Tour ==="
    @echo ""
...
help-me:
    @echo "=== heterogenous-mobile-computing Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/heterogenous-mobile-computing/issues/new"
    @echo ""
