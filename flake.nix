{
  description = "heterogenous-mobile-computing - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 heterogenous-mobile-computing development environment"
            echo "Language: rust"
            echo ""
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          pname = "heterogenous-mobile-computing";
          version = "0.1.0";
          src = ./.;
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P heterogenous-mobile-computing.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/heterogenous-mobile-computing $out/bin/  # Rust
            # cp bin/heterogenous-mobile-computing $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/heterogenous-mobile-computing";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-heterogenous-mobile-computing" {
