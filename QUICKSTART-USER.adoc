...
// Replace heterogenous-mobile-computing, Heterogenous Mobile Computing — See README.adoc for details., just run, Heterogenous Mobile Computing started successfully. with actuals
= heterogenous-mobile-computing — Quick Start for Users
:toc:
:toclevels: 2

== What is heterogenous-mobile-computing?

Heterogenous Mobile Computing — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./heterogenous-mobile-computing-portable
----
...
[source]
----
Heterogenous Mobile Computing started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/heterogenous-mobile-computing/wiki
